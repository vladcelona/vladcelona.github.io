...
const cart = products.filter((product) => localStorage.getItem(product.id) !== '0');
...
function handleAddToCart(product) {
  ...
  products.filter((product) => localStorage.getItem(product.id) !== '0').forEach(addProductToPage);
  updateCartIcon(); updatePrice();
}
